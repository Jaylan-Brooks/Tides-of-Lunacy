...
public class SpawnPiscinoid : MonoBehaviour
{
   ...
   private int RandomizeEnemy(){
      ...
      if (currentWave == 6){
         ...
         if (random > 0.25f && random <= 0.60f){
            enemy = 1;
         }
         if (random > 0.60f && random <= 0.85f){
            enemy = 2;
         }
         if (random > 0.85f){
            enemy = 3;
